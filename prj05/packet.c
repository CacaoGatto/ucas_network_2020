...
void broadcast_packet(iface_info_t *iface, char *packet, int len) {
    ...
    //fprintf(stdout, "TO implement the broadcast process here.\n");
    iface_info_t *pos; //temp iface for traversal
    list_for_each_entry(pos, &instance->iface_list, list) { //traverse global list
